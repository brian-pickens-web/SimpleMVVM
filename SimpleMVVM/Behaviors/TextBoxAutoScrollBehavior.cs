...
{
    public class TextBoxAutoScrollBehavior
    {
        ...
        public static readonly DependencyProperty ScrollOnTextChangedProperty =
            DependencyProperty.RegisterAttached("ScrollOnTextChanged", typeof(bool), typeof(TextBoxAutoScrollBehavior), new PropertyMetadata(false, OnScrollOnTextChanged));
